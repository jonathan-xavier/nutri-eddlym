  ...
  return (
    <section className="relative overflow-hidden pt-12 pb-20 sm:pt-16 sm:pb-28">
      ...
      <div className="section-container grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <div>
          <p className="mb-4 inline-flex rounded-full bg-primary-light px-4 py-1.5 text-sm font-semibold text-primary">
            {site.modalityLabel}
          </p>
          <h1 className="text-4xl font-bold leading-tight tracking-tight text-foreground sm:text-5xl lg:text-[3.25rem] lg:leading-[1.1]">
            {site.hero.headline}
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-muted">{site.hero.subheadline}</p>
          <ul className="mt-8 space-y-3 text-sm text-foreground/90 sm:text-base">
            {[
        ...
        <div className="relative">
          <SiteImage
            ...
            priority
            className="aspect-[4/5] w-full max-w-md mx-auto rounded-2xl shadow-xl ring-1 ring-border lg:max-w-none"
            imageClassName="object-cover object-top"
            sizes="(max-width: 1024px) 90vw, 480px"
          />
          <div className="absolute -bottom-4 -left-2 rounded-2xl border border-border bg-card px-4 py-3 shadow-md sm:-left-6">

...
export function IconLeaf({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden>
      <path d="M12 3c-4 6-8 8-8 14a8 8 0 0016 0c0-6-4-8-8-14z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconHeart({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden>
      <path d="M12 21s-7-4.35-9.33-8.5C.5 9.5 2.5 5 6.5 5c2 0 3.5 1.5 5.5 3.5C14 6.5 15.5 5 17.5 5c4 0 6 4.5 3.83 7.5C19 16.65 12 21 12 21z" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function SpecialtyIcon({
  ...
  name: keyof typeof specialtyIcons;
  className?: string;
}) {
